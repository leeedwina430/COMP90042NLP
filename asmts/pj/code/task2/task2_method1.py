##################################################
# Method 1:  BERT + 4 class classification       #
###################################################
...
df_train['claim_evidence_text'] = train_claim[['claim_text', 'evidences']].apply(concate, axis=1)

df_test = dev_claim[['num_label']]
df_test['claim_evidence_text'] = dev_claim[['claim_text', 'evidences']].apply(concate, axis=1)
